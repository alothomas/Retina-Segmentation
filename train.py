...
class CustomDataset(Dataset):
    def __init__(self, image_dir, mask_dir, augment=True, denoise=True):
    ...
    def __getitem__(self, idx):
        ...
        if self.denoise:
            image = cv2.fastNlMeansDenoising(image, None, h=20, templateWindowSize=7, searchWindowSize=21)
...
# Data Loaders
BATCH_SIZE = 4
train_dataset = CustomDataset('../data_model/train/images' , '../data_model/train/masks', augment=True, denoise=True)
val_dataset = CustomDataset('../data_model/test/images', '../data_model/test/masks', denoise=True)
